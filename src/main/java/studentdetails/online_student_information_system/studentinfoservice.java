...
public class studentinfoservice implements UserDetailsService {
    ...
    public List<studentinfoEntity> findByCA(String cA) {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'findByCA'");
    }

    public void updateByStudentClassadvisor(String newdept) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'updateByStudentClassadvisor'");
    }
}